...
Leave a trace. No account needed — just a name and a message.
...
<form id="gastbok-form" method="POST" action="https://api.staticman.net/v3/entry/github/OlaJanson/olajanson.github.io/v5/gastbok">
  ...
  <textarea id="message" name="fields[message]" required placeholder="What do you want to say?" rows="4"></textarea>
...
<div id="tack" style="display:none">
  <p>Thank you! Your message will appear after review.</p>
</div>

<div id="gastbok-entries">
  <h2>Previous messages</h2>
  <div id="entries-list">
    <p class="empty-hint">No messages yet — be the first!</p>
  </div>
</div>

<script>
(function() {
  // Show thank-you message if redirect with ?tack=1
  ...
  fetch('/static/gastbok-entries.json')
    ...
    .catch(function() { /* empty list is OK */ });
