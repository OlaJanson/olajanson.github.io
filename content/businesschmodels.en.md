...
> "A **business model** or **company model**, English _business model_, is in [corporate economics](https://en.wikipedia.org/wiki/Business_economics "Business economics") a theoretical description of how a [company](https://en.wikipedia.org/wiki/Company "Company"), or a business activity, is intended to function. It's a conceptual tool that contains a set of components and describes their mutual relations in such a way that the business logic for a particular activity can be described concretely." https://sv.wikipedia.org/wiki/Aff%C3%A4rsmodell
